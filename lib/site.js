  ...
  locations: [
    {
      ...
      // Heartland Restaurant online ordering. A per-location subdomain on the
      // POS vendor's own host, which is why the current site cannot show a cart,
      // a menu price, or a pickup time without sending the customer away.
...
/** Michigan sales tax on prepared food. Used for the order estimate only. */
