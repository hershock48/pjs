    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            price: 13.75, half: 8.99,
            signature: true,
            // This photograph is identifiably THIS sandwich: marble rye, swiss,
            // corned beef and coleslaw with shredded carrot in it. It spent a
            // while attached to the Grilled Cheese Pleaser, which is a three
            // cheese sandwich on sourdough, and the one person guaranteed to
            // notice a photo of the wrong sandwich is the owner it was built
            // to impress. A photo is a claim like a price is.
            photo: "/assets/pjs/grilled.webp",
            photoAlt: "The Jomama cut in half on green checkered deli paper: corned beef, swiss and coleslaw on grilled marble rye.",
          },
          {
...
/**
 * Catering, transcribed from their own page — which is ALMOST fully priced,
 * and the almost matters. Their page prints no price for the garden salad
 * (Caesar, directly under it, is 40/75). For a while this file had the
 * Caesar's numbers copied onto the garden salad, which is precisely the
 * invented-price failure the whole build exists to avoid, caught only when the
 * claims audit re-read their live page. If their page does not print it,
 * `prices` is [] and the row renders "call for a price", and the item is not
 * orderable. Worth noting in the pitch either way: the site can publish
 * prices. The retail menus just do not.
 */
  ...
  groups: [
    {
      ...
      items: [
        ...
        { name: "Garden salad", desc: "Romaine, tomato, cucumber, croutons, Italian, ranch and balsamic.", prices: [] },
