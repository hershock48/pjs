    ...
    sections: [
      {
        ...
        items: [
          { name: "Sausage, egg & cheese", price: null },
          { name: "Bacon, egg & cheese", price: null, photo: "/assets/pjs/breakfast.webp", photoAlt: "A bacon, egg and cheese biscuit with a hash brown." },
          { name: "Pastrami & egg", price: null },
        ],
      },
      {
        ...
        items: [
          { name: "Sausage", price: null },
          { name: "Bacon & avocado", price: null },
          { name: "Pastrami", price: null },
          { name: "Corned beef hash", price: null },
        ],
      },
      {
        title: "Plates",
        items: [
          ...
          { name: "Breakfast pizza", price: null },
        ],
      },
      {
    ...
    sections: [
      {
        title: null,
        items: [
          { name: "The Mitten", desc: "Michigan-raised turkey, Sy Ginsberg pastrami, swiss, lettuce, tomato, onion, mayo, mustard.", price: null },
          { name: "Baby Bull", desc: "Roast beef, provolone, lettuce, tomato, onion, horseradish sauce.", price: null },
          { name: "The Big Foot", desc: "Ham, genoa salami, provolone, lettuce, tomato, onion, banana peppers, Joe’s dressing.", price: null },
          {
          ...
          { name: "Joe’s Club", desc: "Michigan-raised turkey, ham, bacon, swiss, lettuce, tomato, onion, mayo.", price: null },
          { name: "Talk of the Town", desc: "Roast beef, turkey, salami, provolone, lettuce, tomato, onion, banana peppers, horseradish sauce.", price: null },
          { name: "The Sparty", desc: "Michigan-raised turkey, bacon, provolone, lettuce, tomato, onion, mayo, pesto.", price: null },
          { name: "PJ’s Chicken Salad", desc: "House-made chicken salad, provolone, lettuce, tomato, onion, mayo.", price: null },
          { name: "The Gobbler", desc: "Michigan-raised turkey, provolone, lettuce, tomato, onion, mayo.", price: null },
          { name: "Ham & Cheese", desc: "Ham, cheddar, lettuce, tomato, onion, mayo.", price: null },
          { name: "Chicken Caesar Wrap", desc: "Grilled chicken, parmesan, romaine, Caesar dressing.", price: null },
          {
            name: "Egg Salad Wrap",
    ...
    sections: [
      {
        title: null,
        items: [
          { name: "Full House", desc: "Romaine, turkey, ham, bacon, tomato, mushroom, onion, croutons, house ranch.", price: null },
          { name: "Crab Louie", desc: "Romaine, crab, swiss, tomato, hard-boiled egg, lemon, croutons, house Russian.", price: null },
          { name: "Spinach & Chicken", desc: "Baby spinach, herb-grilled chicken, hard-boiled egg, bacon, croutons, house sweet onion vinaigrette.", price: null },
          { name: "Chopped Italian", desc: "Romaine, provolone, pepperoni, salami, capocollo, banana peppers, tomato, onion, parmesan, Joe’s Italian.", price: null },
          { name: "Grilled Chicken Caesar", desc: "Herb-grilled chicken, romaine, parmesan, croutons, lemon, Caesar. Available without chicken.", price: null },
          { name: "Side Salad", desc: "Romaine, tomato, onion, cucumber, croutons, dressing of choice.", price: null },
          { name: "Side Caesar", desc: "Romaine, parmesan, croutons, Caesar.", price: null },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: null,
        items: [
          { name: "Lots-o-roni", desc: "PJ’s red sauce, crispy pepperoni, mozzarella.", price: null },
          { name: "The Sicilian Villain", desc: "PJ’s red sauce, Italian sausage, pepperoni, capocollo, green peppers, onions, mozzarella.", price: null },
          { name: "Tuscan Veggie", desc: "PJ’s red sauce, spinach, onion, roasted red peppers, mozzarella, pesto drizzle.", price: null },
          { name: "BBQ Chicken", desc: "Sweet Baby Ray’s, grilled chicken, onion, mozzarella.", price: null },
          { name: "Let's Make a Dill", desc: "Ranch, pickle slices, mozzarella, dill.", price: null },
          { name: "Joe’s Hawaiian Delight", desc: "PJ’s red sauce, ham, pineapple, green pepper, mozzarella.", price: null },
          { name: "My Very Own Cheese Pizza", desc: "PJ’s red sauce, mozzarella.", price: null },
        ],
      },
    ],
  },
