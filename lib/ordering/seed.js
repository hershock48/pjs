  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Five bagels, with two 8oz cream cheeses of your choice.",
        ...
        groups: [
          {
            ...
            multi: false,
            choices: [
              { name: "Pasta salad", priceCents: 0 },
              { name: "Coleslaw", priceCents: 0 },
            ],
          },
        ],
      },
...
/**
 * The sandwich board, seeded HIDDEN and unpriced, so the menu editor at
 * /kitchen shows the owner exactly what turning it on looks like: type a price,
 * untick hidden, save. Nothing here is orderable and nothing here carries a
 * number we made up.
 */
export const HIDDEN_BOARD_NOTE =
  "Their full sandwich board is not seeded. It has no published prices anywhere, and the menu editor is where it gets added.";
